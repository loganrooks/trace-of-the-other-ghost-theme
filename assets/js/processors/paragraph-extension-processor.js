...
class ParagraphExtensionProcessor extends ContentProcessor {
  ...
  /**
   * Inject CSS animations and styles for extensions
   * Moved from DOMContentLoaded to proper initialization
   * @private
   */
  injectExtensionCSS() {
    if (!document.getElementById('extension-animations')) {
      ...
      console.log('[EXTENSION_PROCESSOR] Extension CSS animations injected');
    }
  }
